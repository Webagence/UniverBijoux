...
const Privacy = () => (
  <LegalPage
    ...
    subtitle="Nous traitons vos données personnelles conformément au RGPD."
    ...
    sections={[
      ...
      { heading: "Vos droits", body: <p>Accès, rectification, effacement, portabilité, opposition : écrivez à privacy@maisonlune.fr.</p> },
