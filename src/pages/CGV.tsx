...
const CGV = () => {
  ...
  return (
    <LegalPage
      ...
      subtitle={`Applicables aux clients professionnels de ${settings.siteName}.`}
      crumb="CGV"
      sections={[
        { heading: "1. Objet", body: <p>Les présentes CGV régissent les ventes conclues entre {settings.siteName} et ses clients professionnels titulaires d'un numéro SIRET valide.</p> },
        ...
        { heading: "3. Commandes", body: <p>La quantité minimale est de 3 pièces par référence. Les commandes sont fermes après validation. Franco de port à partir de {settings.freeShippingFrom}€ HT en France métropolitaine.</p> },
        ...
        { heading: "7. Propriété intellectuelle", body: <p>Tous les visuels, fiches produit et marques restent la propriété exclusive de {settings.siteName}.</p> },
