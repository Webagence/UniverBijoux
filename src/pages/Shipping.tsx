...
const Shipping = () => (
  <LegalPage
    ...
    subtitle="Nos engagements logistiques pour nos partenaires revendeurs."
    crumb="Livraison"
    sections={[
      { heading: "Délais & zones", body: <p>France métropolitaine : 48h ouvrées. UE : 3 à 5 jours ouvrés. International : sur devis.</p> },
      { heading: "Frais de port", body: <p>Offerts dès 300€ HT en France. 12€ HT en dessous. UE : 25€ HT forfaitaire.</p> },
