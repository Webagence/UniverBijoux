...
const ProductGrid = () => {
  ...
  if (!productGridSection) return <ProductGridSkeleton />;

  return (
    <section id="collection" className="container py-20 md:py-28">
      <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
        <div className="text-gold text-xs tracking-luxe uppercase">{productGridSection.eyebrow}</div>
        <h2 className="font-serif text-4xl md:text-5xl text-bordeaux">
          {productGridSection.heading} <em>{productGridSection.headingEm}</em>
        </h2>
